...
import { formatDate, formatFileSize, splitLinkFromMessage } from "../../utils/helpers";
      ...
      >
        {message.type === "text" ? (
          ...
          <div
            onClick={(e) => e.stopPropagation()}
            title={formattedDate}
            className="border-dark-lighten rounded-lg border p-3"
          >
        ...
        {message.type !== "removed" && (
          <>
            ...
            <button
              ...
              className="opacity-0 transition hover:text-gray-300 group-hover:opacity-100"
            >
              <ReplyIcon />
            </button>
            ...
            <button
              ...
              className="text-lg opacity-0 transition hover:text-gray-300 group-hover:opacity-100"
            >
              ...
              >
                {(ref) => (
                  <ReactionPopup
                    ...
                    currentReaction={
                      message.reactions?.[authUser?.uid as string] || 0
                    }
                  />
                )}
              </ClickAwayListener>
