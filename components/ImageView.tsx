...
const ImageView: FC<ImageViewProps> = ({ src, isOpened, setIsOpened }) => {
  return (
    ...
    >
      ...
      <button
        onClick={() => setIsOpened(false)}
        className="bg-dark-lighten fixed right-2 top-2 z-30 flex h-10 w-10 items-center justify-center rounded-full transition duration-300 hover:brightness-125"
      >
